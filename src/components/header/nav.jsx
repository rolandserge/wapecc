        ...
        <ul className="menu-nav">
            ...
            <li>
                ...
                <ul className="submenu">
                    <li><Link to="#" className="lien">WHY WAPECC IN WEST AFRICA</Link></li>
            ...
            <li>
                ...
                <ul className="submenu">
                    <li><Link to="#" className="lien">INVESTMENT CLIMATE</Link></li>
                    <li><Link to="#" className="lien">ECONOMIC DIVERSIFICATION</Link></li>
                    <li><Link to="#" className="lien">REGIONAL HUB</Link></li>
                    <li><Link to="#" className="lien">INVESTMENT IN ENERGY / POWER AND INFRASTRUCTURE</Link></li>
                    <li><Link to="#" className="lien">THE FEDERAL MINISTRY OF POWER OF NIGERIA</Link></li>
                </ul>
            </li>
            <li>
                <span>Register</span>
